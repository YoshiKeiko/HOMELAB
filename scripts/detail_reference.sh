...
################################################################################
# Generate Enhanced HomeLab Service Reference with Detailed Descriptions
################################################################################

set -euo pipefail

HOMELAB_DIR="$HOME/HomeLab"
OUTPUT_FILE="$HOMELAB_DIR/docs/SERVICE_REFERENCE_DETAILED.md"

TAILSCALE_IP=$(tailscale ip -4 2>/dev/null || echo "YOUR_TAILSCALE_IP")
TOTAL_SERVICES=$(docker ps --format '{{.Names}}' | wc -l | tr -d ' ')

echo "Generating detailed service reference guide..."
...
- **Remote:** [http://TAILSCALE_IP:9000](http://TAILSCALE_IP:9000)
...
- **Remote:** [http://TAILSCALE_IP:32400/web](http://TAILSCALE_IP:32400/web)
...
- **Remote:** [http://TAILSCALE_IP:8096](http://TAILSCALE_IP:8096)
...
- **Remote:** [http://TAILSCALE_IP:7878](http://TAILSCALE_IP:7878)
...
- **Remote:** [http://TAILSCALE_IP:8989](http://TAILSCALE_IP:8989)
...
- **Remote:** [http://TAILSCALE_IP:9696](http://TAILSCALE_IP:9696)
...
- **Remote:** [http://TAILSCALE_IP:5055](http://TAILSCALE_IP:5055)
...
- **Remote:** [http://TAILSCALE_IP:9091](http://TAILSCALE_IP:9091)
...
- **Remote:** [http://TAILSCALE_IP:3000](http://TAILSCALE_IP:3000)
...
- **Remote:** [http://TAILSCALE_IP:11434](http://TAILSCALE_IP:11434)
...
- **Remote:** [http://TAILSCALE_IP:8443](http://TAILSCALE_IP:8443)
...
- **Remote:** [http://TAILSCALE_IP:8888](http://TAILSCALE_IP:8888)
...
- **Remote:** [http://TAILSCALE_IP:3001](http://TAILSCALE_IP:3001)
- **SSH:** Port 2222
...
- **Remote:** [http://TAILSCALE_IP:8123](http://TAILSCALE_IP:8123)
...
- **Remote:** [http://TAILSCALE_IP:1880](http://TAILSCALE_IP:1880)
...
- **Remote:** [http://TAILSCALE_IP:8080](http://TAILSCALE_IP:8080)
...
- **Remote:** [http://TAILSCALE_IP:6052](http://TAILSCALE_IP:6052)
...
- **Remote:** [http://TAILSCALE_IP:3003](http://TAILSCALE_IP:3003)
...
- **Remote:** [http://TAILSCALE_IP:9090](http://TAILSCALE_IP:9090)
...
- **Remote:** [http://TAILSCALE_IP:3100](http://TAILSCALE_IP:3100)
...
- **Remote:** [http://TAILSCALE_IP:3004](http://TAILSCALE_IP:3004)
...
- **Remote:** [http://TAILSCALE_IP:19999](http://TAILSCALE_IP:19999)
...
- **Remote:** [http://TAILSCALE_IP:8085](http://TAILSCALE_IP:8085)
...
- **Remote:** [http://TAILSCALE_IP:8097](http://TAILSCALE_IP:8097)
- **Login:** admin / (from credentials file)
...
- **Remote:** [http://TAILSCALE_IP:8384](http://TAILSCALE_IP:8384)
...
- **Remote:** [http://TAILSCALE_IP:8200](http://TAILSCALE_IP:8200)
...
- **Remote:** [http://TAILSCALE_IP:8087](http://TAILSCALE_IP:8087)
...
- **Remote:** [http://TAILSCALE_IP:8088](http://TAILSCALE_IP:8088)
...
- **Remote:** [http://TAILSCALE_IP:8089](http://TAILSCALE_IP:8089)
...
- **Remote:** [http://TAILSCALE_IP:8090](http://TAILSCALE_IP:8090)
...
- **Remote:** [http://TAILSCALE_IP:8091](http://TAILSCALE_IP:8091)
...
- **Remote:** [http://TAILSCALE_IP:4000](http://TAILSCALE_IP:4000)
...
- **Remote:** [http://TAILSCALE_IP:8092](http://TAILSCALE_IP:8092)
...
- **Remote:** [http://TAILSCALE_IP:8093](http://TAILSCALE_IP:8093)
...
- **Remote:** [http://TAILSCALE_IP:2342](http://TAILSCALE_IP:2342)
- **Login:** admin / (from credentials file)
...
- **Remote:** [http://TAILSCALE_IP:8094](http://TAILSCALE_IP:8094)
...
- **Remote:** [http://TAILSCALE_IP:8098](http://TAILSCALE_IP:8098)
...
- Your Mac IP: TAILSCALE_IP
- Access format: `http://TAILSCALE_IP:PORT`
...
sed -i '' "s/TAILSCALE_IP/${TAILSCALE_IP}/g" "$OUTPUT_FILE"

echo ""
echo "✅ Detailed service reference created!"
echo ""
...
echo ""
echo "This file includes detailed 'What it is' and 'What it does' for ALL 47 services!"
echo ""