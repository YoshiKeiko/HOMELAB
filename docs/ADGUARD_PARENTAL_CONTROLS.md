...
```
Primary DNS:   192.168.68.50    (AdGuard - blocks ads + adult)
...
**Deco DNS Configuration:**
```
Primary DNS:   192.168.68.50    (AdGuard)
...
**Deco DNS Settings:**
```
Primary DNS:   192.168.68.50    (Your Mac - AdGuard with parental controls)
...
**DNS Setup:**
```
Primary:   192.168.68.50 (AdGuard - full filtering)
