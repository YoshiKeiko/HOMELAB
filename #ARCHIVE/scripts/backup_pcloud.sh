...
################################################################################
# Setup Automatic Backups to pCloud with Duplicati
################################################################################
...
echo ""
echo "╔═══════════════════════════════════════════════════════════════╗"
echo "║         SETUP AUTOMATIC PCLOUD BACKUPS                         ║"
echo "╚═══════════════════════════════════════════════════════════════╝"
echo ""

cat > "$HOME/HomeLab/docs/PCLOUD_BACKUP_COMPLETE_GUIDE.md" << 'EOF'
...
echo ""
echo "═══════════════════════════════════════════════════════════════"
echo "  pCloud Backup Guide Created!"
echo "═══════════════════════════════════════════════════════════════"
echo ""
echo "View complete guide:"
echo "  open ~/HomeLab/docs/PCLOUD_BACKUP_COMPLETE_GUIDE.md"
echo ""
echo "Quick Start:"
echo ""
echo "1. Open Duplicati: http://localhost:8200"
echo ""
echo "2. Get pCloud WebDAV credentials:"
echo "   URL: https://webdav.pcloud.com"
echo "   Username: Your pCloud email"
...
echo "   - Source: /Users/homelab/HomeLab/Docker/Data"
echo "   - Schedule: Daily at 3 AM"
echo ""
echo "4. IMPORTANT: Save encryption passphrase in 1Password!"
echo ""
echo "Complete step-by-step in guide above!"
echo ""

chmod +x /mnt/user-data/outputs/create-complete-guide.sh