...
echo ""
echo "═══════════════════════════════════════════════════════════════"
echo "  Plex 4TB Storage Configuration"
echo "═══════════════════════════════════════════════════════════════"
echo ""
...
log_info "Detecting external drives..."
echo ""
diskutil list external

cat > "$HOME/HomeLab/docs/PLEX_4TB_STORAGE_SETUP.md" << 'EOF'
# 📦 Plex 4TB Storage Configuration Guide
...
echo ""
echo "═══════════════════════════════════════════════════════════════"
echo "  Complete Guide Created"
echo "═══════════════════════════════════════════════════════════════"
echo ""
echo "View guide:"
echo "  ${CYAN}open ~/HomeLab/docs/PLEX_4TB_STORAGE_SETUP.md${NC}"
echo ""
echo -e "${YELLOW}Quick Start:${NC}"
echo ""
echo "1. Find your drive name:"
echo "   ${CYAN}diskutil list external${NC}"
echo ""
echo "2. Create folders (replace 'External SSD' with YOUR drive name):"
echo "   ${CYAN}DRIVE=\"/Volumes/External SSD\"${NC}"
echo "   ${CYAN}mkdir -p \"\$DRIVE/Media\"/{Movies,TV\\ Shows,Music,Photos}${NC}"
echo "   ${CYAN}mkdir -p \"\$DRIVE/Downloads\"/{incomplete,complete/{movies,tv}}${NC}"
echo ""
echo "3. Update Plex volumes in compose file"
echo "4. Restart Plex"
echo "5. Add libraries in Plex web interface"
echo ""
echo "The guide has complete step-by-step instructions!"
echo ""